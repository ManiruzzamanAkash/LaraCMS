...
.st0{fill:#333333;}
                ...
                <a href="/previews/9.0.0/demo-cleaning-services-contact.html" class="btn btn-primary font-weight-bold px-5 py-3 mb-2">BOOK NOW</a>
            </div>
            <div class="col-md-4 col-lg-2 mb-4 mb-md-0">
                <h4 class="font-weight-bold ls-0">Our Services</h4>
                <ul class="list-unstyled mb-0">
                    <li class="mb-1">
                        <a href="/previews/9.0.0/demo-cleaning-services-services-detail.html">Building Services</a>
                    </li>
                    <li class="mb-1">
                        <a href="/previews/9.0.0/demo-cleaning-services-services-detail.html">Post Construction</a>
                    </li>
                    <li class="mb-0">
                        <a href="/previews/9.0.0/demo-cleaning-services-services-detail.html">Office Cleaning</a>
                    </li>
                </ul>
                <a href="/previews/9.0.0/demo-cleaning-services-services.html" class="btn btn-link font-weight-bold text-decoration-none ps-0">VIEW MORE</a>
            </div>
            <div class="col-md-4 col-lg-2 mb-4 mb-md-0">
                <h4 class="font-weight-bold ls-0">About</h4>
                <ul class="list-unstyled mb-0">
                    <li class="mb-1">
                        <a href="/previews/9.0.0/demo-cleaning-services-about-us.html">About Us</a>
                    </li>
                    <li class="mb-0">
                        <a href="/previews/9.0.0/demo-cleaning-services-contact.html">Send a Message</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="container container-xl-custom pb-4">
            ...
            <div class="row py-4 mt-2">
                <div class="col-lg-6 text-center text-lg-start mb-3 mb-lg-0">
                    <a href="/previews/9.0.0/demo-cleaning-services.html">
                        <img alt=""  width="115" height="30" src="{{ asset('public/img/common/logo-light.png') }}">
      </a>
      </div>
      <div class="col-lg-6 text-center text-lg-end">
          <p class="text-3 mb-0">Business Website Services. © 2021. All Rights Reserved</p>
      </div>
      </div>
      </div>
      </div> --}}
