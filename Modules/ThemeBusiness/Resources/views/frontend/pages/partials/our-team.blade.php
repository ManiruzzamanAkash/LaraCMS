    ...
    <div class="container pt-5 mt-5">
        <div class="row justify-content-center pb-2 mb-3">
            <div class="col-md-9 col-lg-12 text-center">
                <h2 class="text-color-secondary font-weight-bold line-height-6 mb-3 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" style="animation-delay: 200ms;">Our Team</h2>
                <p class="custom-font-secondary text-4 mb-3 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" style="animation-delay: 400ms;">
                                    ...
                                    <div class="card custom-card-style-1 custom-card-style-1-variation">
                                        <div class="card-body text-center bg-color-light-scale-1 py-5">
                                            <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                                <a href="/.html#">
                                                    <img src="{{ asset('public/modules/theme-business/images/common/team-4.jpg') }}" class="img-fluid rounded-circle" alt="">
                                                </a>
                                            </div>
                                            <h4 class="text-color-secondary font-weight-bold line-height-1 text-5 mb-0">
                                                <a href="/.html#" class="text-color-secondary text-color-hover-primary text-decoration-none">
                                                    Jahangir Alam
                                                </a>
                                            </h4>
                                            <p class="text-2 pb-1 mb-2">CEO - Chief Executive Officer</p>
                                ...
                                <div>
                                    <div class="card custom-card-style-1 custom-card-style-1-variation">
                                        <div class="card-body text-center bg-color-light-scale-1 py-5">
                                            <div class="custom-card-style-1-image-wrapper bg-primary rounded-circle d-inline-block mb-3">
                                                <a href="/.html#">
                                                    <img src="{{ asset('public/modules/theme-business/images/common/team-2.jpg') }}" class="img-fluid rounded-circle" alt="">
                                                </a>
                                            </div>
                                            <h4 class="text-color-secondary font-weight-bold line-height-1 text-5 mb-0">
                                                <a href="/.html#" class="text-color-secondary text-color-hover-primary text-decoration-none">Selena Gome</a>
                                            </h4>
                                            <p class="text-2 pb-1 mb-2">
                                                Technical Officer
                                            </p>
                                            <ul class="social-icons custom-social-icons social-icons-big">
                                                <li class="social-icons-instagram"><a href="https://www.instagram.com/" target="_blank" title="Instagram"><i class="fab fa-instagram"></i></a></li>
