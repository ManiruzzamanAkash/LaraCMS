                ...
                <div class="col-lg-6 pe-lg-4 mb-5 mb-lg-0">
                    <div class="card border-0 custom-border-radius-1 box-shadow-1 appear-animation animated fadeInUpShorter appear-animation-visible"
                        ...
                        <div class="card-body p-5">
                            <h2 class="text-color-secondary font-weight-bold text-7 line-height-1 mb-1">Book a schedule</h2>
                            <p class="custom-font-secondary text-4 pb-1 mb-4">Enter your details in the form and we will
                                call you back.</p>
                            <form class="contact-form custom-form-style-1" action="/previews/9.0.0/php/contact-form.php"
                                ...
                                <div class="row">
                                    <div class="form-group col pb-1 mb-3">
                                        <input type="text" value="" data-msg-required="Please enter your name."
                                            maxlength="100" class="form-control" name="name" placeholder="Your Name"
                                            required="">
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col pb-1 mb-3">
                                        <div class="custom-select-1">
                                            <select data-msg-required="Please select a service." class="form-control"
                                ...
                                <div class="row">
                                    <div class="form-group col">
                                        <button type="submit"
                                            ...
                                            data-loading-text="Loading...">CALL ME BACK</button>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <div class="container pt-5 pb-3 mt-4">
                <div class="row mt-5 mb-5">
                    <div class="col-lg-4 pe-lg-0 mb-4 mb-lg-0">
                        ...
                        <p class="text-color-light opacity-7 mb-0">We value our customer needs and provide great service and they are more than happy to stay with us...</p>
                    </div>
                                ...
                                <div class="owl-stage"
                                    ...
                                    <div class="owl-item cloned" style="width: 372px; margin-right: 20px;">
                                        <div>
                                            <div class="testimonial testimonial-style-3 custom-testimonial-style-1">
                                                <blockquote>
                                                    <p class="mb-0">
                                                        We value our customer needs and provide great service and they are more than happy to stay with us...
                                                    </p>
                                                </blockquote>
                                    ...
                                    <div class="owl-item cloned" style="width: 372px; margin-right: 20px;">
                                        <div>
                                            <div class="testimonial testimonial-style-3 custom-testimonial-style-1">
                                                <blockquote>
                                                    <p class="mb-0">We value our customer needs and provide great service and they are more than happy to stay with us... </p>
                                                </blockquote>
                                                <div class="testimonial-author">
                                                    <div class="testimonial-author-thumbnail">
                                                    ...
                                                    <p><strong class="text-color-light font-weight-semibold text-4 mb-1">Robert Joe</strong><span class="text-color-light text-2">Sydney, Australia</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container pb-5 mb-3">
                ...
                <div class="row">
                                ...
                                <div class="card-body p-3 z-index-1">
                                    <a href="/-blog-post.html">
                                        <img class="card-img-top border-radius-0 mb-2"
                                            src="{{ asset('public/modules/theme-business/images/common/background-4.jpeg') }}" alt="Card Image">
                                    </a>
                        ...
                        <article>
                            <div class="card border-0 border-radius-0 box-shadow-1">
                                <div class="card-body p-3 z-index-1">
                                    <a href="/-blog-post.html">
                                        <img class="card-img-top border-radius-0 mb-2"
                                            src="{{ asset('public/modules/theme-business/images/common/blog-2.jpg') }}" alt="Card Image">
                                    </a>
                                    <p class="text-uppercase text-color-default text-1 my-2">
                                        <time pubdate="" datetime="2021-01-10">10 Jan 2021</time>
                                        <span class="opacity-3 d-inline-block px-2">|</span>
                    ...
                    <div class="col-lg-4">
                        <div class="row">
                            <div class="col-12">
                                <h3 class="text-color-secondary font-weight-bold text-transform-none text-6 mb-3 appear-animation">More Articles</h3>
