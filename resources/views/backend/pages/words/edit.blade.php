                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group has-success">
                                ...
                                <select class="form-control custom-select" id="is_section" name="is_section" required>
                                    <option value="1" {{ $word->is_section === 1 ? 'selected' : null }}>Yes</option>
                                    <option value="0" {{ $word->is_section === 0 ? 'selected' : null }}>No</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="order_nr" name="order_nr" value="{{ $word->order_nr }}" placeholder="Enter Display Order No." required="" />
                            </div>
                            <p class="text-warning">
