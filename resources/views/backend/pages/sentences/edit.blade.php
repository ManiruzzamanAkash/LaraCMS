            ...
            <div class="form-body">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label" for="category_id">Sentence Category <i class="fa fa-chevron-right"></i> Chapter <span class="required">*</span></label>
                                <br>
                        ...
                        <div class="col-md-3">
                            <div class="form-group has-success">
                                ...
                                <select class="form-control custom-select" id="is_section" name="is_section" required>
                                    <option value="1" {{ $sentence->is_section === 1 ? 'selected' : null }}>Yes</option>
                                    <option value="0" {{ $sentence->is_section === 0 ? 'selected' : null }}>No</option>
                                </select>
                                <p class="text-warning">
                                    <i class="fa fa-info-circle"></i> If Yes, it will not be included as sentence
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="order_nr" name="order_nr" value="{{ $sentence->order_nr }}" placeholder="Enter Display Order No." required="" />
                            </div>
                            <p class="text-warning">
